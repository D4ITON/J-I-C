$(function() {
    ...
    // var slider on change

    //HANDLE COMPRESS BUTTON click en compress
    document.querySelector('#input-range').addEventListener('change', function() {
      console.log(this.value);
      document.querySelector("#jpeg_encode_quality").value = this.value;
    });

    document.querySelector('#input-range').addEventListener('change', function(e) {
    // encodeButton.addEventListener('click', function(e) {
        ...
        // console.log(result_image.src);
        var src = result_image.src;
        var base64str = src.substr(23);
        var decoded = atob(base64str);
        // console.log("Filesize:" + (parseInt(decoded.length) / 1024) + " Kb");
        console.log("Filesize:" + (decoded.length.toLocaleString()) + " Kb");
